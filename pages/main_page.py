...
class MainPage:
    ...
    def check_if_login_button_is_present(self):
        login_button = self.browser.find_element(*MainPage.LOGIN_BUTTON)
    ...
    def click_registration_button(self):
        registration_button = self.browser.find_element(*MainPage.REGISTRATION_BUTTON)
        registration_button.click()

    def check_input_name_field_shows(self):
        return WebDriverWait(self.browser, 10).until(EC.visibility_of_element_located(MainPage.NAME_FIELD))

    def click_name(self):
        name_field = self.browser.find_element(*MainPage.NAME_FIELD)
        name_field.click()
    ...
    def click_password(self):
        name_field = self.browser.find_element(*MainPage.PASSWORD_FIELD)
        name_field.click()
    ...
    def click_submit_login_button(self):
        submit_login_button = self.browser.find_element(*MainPage.SUBMIT_LOGIN_BUTTON)
